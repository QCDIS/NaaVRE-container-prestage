...
import json
filename = "/tmp/remote_path_geotiffs_str_" + id + ".json"
file_remote_path_geotiffs_str = open(filename, "w")
file_remote_path_geotiffs_str.write(json.dumps(remote_path_geotiffs_str))
file_remote_path_geotiffs_str.close()
